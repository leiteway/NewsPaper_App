...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var saltRounds, password, encryptedPassword, newUser, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                newUser = _a.sent();
                return [4 /*yield*/, (0, jwt_1.createToken)(newUser)];
            case 3:
                token = _a.sent();
...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, checkPassword, token, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, UserModel_1.default.findOne({ where: { email: req.body.email } })];
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, res.status(404).send({ error: "USER_NOT_FOUND" })];
                }
                return [4 /*yield*/, bcryptjs_1.default.compare(req.body.password, user.password)];
            case 2:
                checkPassword = _a.sent();
                if (!checkPassword) {
                    return [2 /*return*/, res.status(401).send({ error: "PASSWORD_INVALID" })];
                }
                return [4 /*yield*/, (0, jwt_1.createToken)(user)];
            case 3:
                token = _a.sent();
                res.status(200).json({ message: 'Log in successfull', token: token, user_role: user.role, user_name: user.name });
                return [3 /*break*/, 5];
            case 4:
                error_2 = _a.sent();
