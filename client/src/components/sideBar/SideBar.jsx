    ...
    <>
      ...
      <div className='sidebar-container'>
        ...
        <section className='contact-container'>
          <img className='contact-bg' src="src/assets/images/bg-sidebar.png" alt="" /> {/* Este es el background del Need Help y tiene que estar de fondo */}              <img className='icon-contact-sidebar' src="src/assets/public/Icon-contact-us.png" alt="Icono de contacto" />
